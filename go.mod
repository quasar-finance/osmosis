...
replace (
	...
	github.com/CosmWasm/wasmd => github.com/quasar-finance/wasmd v0.0.0-20220630082102-09832fbe7603
	...
	github.com/cosmos/ibc-go/v3 => github.com/polymerdao/ibc-go/v3 v3.0.0-alpha1.0.20220915045509-80f23dc41efa
